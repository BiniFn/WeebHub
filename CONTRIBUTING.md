...
2. Fork the repository, clone it, and create a new branch.
	...
	git clone https://github.com/<your-username>/weebhub.git
	# Navigate to the directory
	cd weebhub
	# Assign to a remote called "upstream"
	git remote add upstream https://github.com/5rahim/weebhub.git
	```
...
[Issues](https://github.com/5rahim/weebhub/issues?q=is%3Aissue+is%3Aopen+label%3A%22open+to+contribution%22)
