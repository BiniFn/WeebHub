...
func main() {
	...
	assets := map[string]struct {
		...
		"MacOS_arm64": {
			Asset: fmt.Sprintf("weebhub-desktop-%s_MacOS_arm64.app.tar.gz", version),
			Sig:   fmt.Sprintf("weebhub-desktop-%s_MacOS_arm64.app.tar.gz.sig", version),
		},
		"MacOS_x86_64": {
			Asset: fmt.Sprintf("weebhub-desktop-%s_MacOS_x86_64.app.tar.gz", version),
			Sig:   fmt.Sprintf("weebhub-desktop-%s_MacOS_x86_64.app.tar.gz.sig", version),
		},
		"Linux_x86_64": {
			Asset: fmt.Sprintf("weebhub-desktop-%s_Linux_x86_64.AppImage", version),
			Sig:   fmt.Sprintf("weebhub-desktop-%s_Linux_x86_64.AppImage.sig", version),
		},
		"Windows_x86_64": {
			AppZip: fmt.Sprintf("weebhub-desktop-%s_Windows_x86_64.exe", version),
			Sig:    fmt.Sprintf("weebhub-desktop-%s_Windows_x86_64.sig", version),
		},
	}
