...
func GenerateHandlerHookEvents(handlersJsonPath string, outputDir string) {
	...
	//f.WriteString("\t\"weebhub/internal/hook_resolver\"\n")

	imports := []string{
		"\"weebhub/internal/api/anilist\"",
		"\"weebhub/internal/api/tvdb\"",
		"\"weebhub/internal/continuity\"",
		"\"weebhub/internal/database/models\"",
		"\"weebhub/internal/debrid/client\"",
		"\"weebhub/internal/debrid/debrid\"",
		"\"weebhub/internal/extension\"",
		"hibikemanga \"weebhub/internal/extension/hibike/manga\"",
		"hibikeonlinestream \"weebhub/internal/extension/hibike/onlinestream\"",
