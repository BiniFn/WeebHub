...
func TestAddBatchHistoryPersistsAndInvalidatesQueries(t *testing.T) {
	...
	torrent := &hibiketorrent.AnimeTorrent{
		Provider: "provider",
		Name:     "[WeebHub] Example Show - 01-12 (1080p).mkv",
		InfoHash: "hash-1",
		IsBatch:  true,
	}
	files := &hibiketorrent.BatchEpisodeFiles{
		...
		Files: []*hibiketorrent.AnimeTorrentFile{{
			Index: 0,
			Path:  "/downloads/[WeebHub] Example Show - 01.mkv",
			Name:  "[WeebHub] Example Show - 01.mkv",
		}},
	}
	...
	require.Equal(t, "WeebHub", history.Metadata.ReleaseGroup)
...
func TestAddBatchHistoryUpdatesExistingRecord(t *testing.T) {
	...
	repo.AddBatchHistory(101, &hibiketorrent.AnimeTorrent{
		Name:     "[WeebHub] Example Show - 05 (1080p).mkv",
		InfoHash: "new-hash",
	}, updatedFiles)
