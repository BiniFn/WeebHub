...
func TestValidateReleaseUrl(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			url:            "https://github.com/5rahim/weebhub/releases/download/v3.5.1/weebhub-denshi-3.5.1_MacOS_arm64.dmg",
			expectedOutput: true,
		},
		{
			url:            "https://github.com/rando/weebhub/releases/download/v3.5.1/weebhub-denshi-3.5.1_MacOS_arm64.dmg",
			expectedOutput: false,
		},
		{
			url:            "https://weebhub.app/api/updates/stable/weebhub-denshi-3.5.1_MacOS_arm64.dmg",
			expectedOutput: true,
		},
		{
