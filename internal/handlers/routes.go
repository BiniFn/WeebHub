...
import (
	...
	util "weebhub/internal/util/proxies"
	"strings"
	"time"
...
func InitRoutes(app *core.App, e *echo.Echo) {
	...
	e.Use(middleware.CORSWithConfig(middleware.CORSConfig{
		...
		AllowHeaders: []string{"Origin", "Content-Type", "Accept", "Cookie", "Authorization",
			"X-WeebHub-Token", clientIdHeaderName, clientIdProofHeaderName, clientPlatformHeader,
			"X-WeebHub-Nakama-Token", "X-WeebHub-Nakama-Username", "X-WeebHub-Nakama-Server-Version", "X-WeebHub-Nakama-Peer-Id"},
