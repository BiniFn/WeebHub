...
const (
	clientIdHeaderName      = "X-WeebHub-Client-Id"
	clientIdProofHeaderName = "X-WeebHub-Client-Id-Proof"
	clientIdCookieName      = "WeebHub-Client-Id"
	clientIdQueryParam      = "id"
	clientIdProofQueryParam = "proof"
	clientPlatformHeader    = "X-WeebHub-Client-Platform"
