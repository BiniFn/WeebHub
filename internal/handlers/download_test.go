...
func TestValidateMacAppArchive(t *testing.T) {
	t.Run("accepts a normal denshi app archive", func(t *testing.T) {
		archivePath := writeZipArchive(t, []zipArchiveEntry{
			{name: "WeebHub Denshi.app/", mode: os.ModeDir | 0755},
			{name: "WeebHub Denshi.app/Contents/", mode: os.ModeDir | 0755},
			{name: "WeebHub Denshi.app/Contents/Frameworks/", mode: os.ModeDir | 0755},
			{name: "WeebHub Denshi.app/Contents/Frameworks/Electron Framework.framework/", mode: os.ModeDir | 0755},
			{name: "WeebHub Denshi.app/Contents/Frameworks/Electron Framework.framework/Versions/", mode: os.ModeDir | 0755},
			{name: "WeebHub Denshi.app/Contents/Frameworks/Electron Framework.framework/Versions/Current", mode: os.ModeSymlink | 0755, content: "A"},
			{name: "WeebHub Denshi.app/Contents/Frameworks/Electron Framework.framework/Electron Framework", mode: os.ModeSymlink | 0755, content: "Versions/Current/Electron Framework"},
			{name: "WeebHub Denshi.app/Contents/Info.plist", mode: 0644, content: "plist"},
		})

		require.NoError(t, validateMacAppArchive(archivePath, "WeebHub Denshi.app"))
	})
	...
	t.Run("rejects archive traversal entries", func(t *testing.T) {
		...
		err := validateMacAppArchive(archivePath, "WeebHub Denshi.app")
		require.Error(t, err)
	...
	t.Run("rejects symlink targets that escape the app bundle", func(t *testing.T) {
		archivePath := writeZipArchive(t, []zipArchiveEntry{
			{name: "WeebHub Denshi.app/", mode: os.ModeDir | 0755},
			{name: "WeebHub Denshi.app/Contents/link", mode: os.ModeSymlink | 0755, content: "../../../../escape"},
		})
	...
	t.Run("rejects unsupported special entries", func(t *testing.T) {
		archivePath := writeZipArchive(t, []zipArchiveEntry{
			{name: "WeebHub Denshi.app/", mode: os.ModeDir | 0755},
			{name: "WeebHub Denshi.app/Contents/special", mode: os.ModeNamedPipe | 0644},
		})
	...
	t.Run("rejects archives without the app bundle", func(t *testing.T) {
		...
		err := validateMacAppArchive(archivePath, "WeebHub Denshi.app")
		require.EqualError(t, err, "app: WeebHub Denshi.app not found in archive")
	})
}
...
func TestExtractMacAppArchive(t *testing.T) {
	archivePath := writeZipArchive(t, []zipArchiveEntry{
		...
		{name: "WeebHub Denshi.app/Contents/Frameworks/Electron Framework.framework/", mode: os.ModeDir | 0755},
		{name: "WeebHub Denshi.app/Contents/Frameworks/Electron Framework.framework/Versions/", mode: os.ModeDir | 0755},
		{name: "WeebHub Denshi.app/Contents/Frameworks/Electron Framework.framework/Versions/A/", mode: os.ModeDir | 0755},
		{name: "WeebHub Denshi.app/Contents/Frameworks/Electron Framework.framework/Versions/A/Electron Framework", mode: 0755, content: "binary"},
		{name: "WeebHub Denshi.app/Contents/Frameworks/Electron Framework.framework/Versions/Current", mode: os.ModeSymlink | 0755, content: "A"},
		{name: "WeebHub Denshi.app/Contents/Frameworks/Electron Framework.framework/Electron Framework", mode: os.ModeSymlink | 0755, content: "Versions/Current/Electron Framework"},
		{name: "WeebHub Denshi.app/Contents/Info.plist", mode: 0644, content: "plist"},
	})
	...
	require.NoError(t, extractMacAppArchive(archivePath, dest, "WeebHub Denshi.app"))

	target, err := os.Readlink(filepath.Join(dest, "WeebHub Denshi.app", "Contents", "Frameworks", "Electron Framework.framework", "Versions", "Current"))
	require.NoError(t, err)
	require.Equal(t, "A", target)

	binaryPath := filepath.Join(dest, "WeebHub Denshi.app", "Contents", "Frameworks", "Electron Framework.framework", "Versions", "A", "Electron Framework")
...
func TestInstallMacAppBundle(t *testing.T) {
	t.Run("replaces the existing app and clears the backup", func(t *testing.T) {
		root := t.TempDir()
		applicationsPath := filepath.Join(root, "Applications", "WeebHub Denshi.app")
		stagedPath := filepath.Join(root, "staged", "WeebHub Denshi.app")
