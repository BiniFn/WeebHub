...
import (
	...
	discordrpc_client "weebhub/internal/discordrpc/client"
...
var (
	defaultActivity = discordrpc_client.Activity{
		...
		Assets: &discordrpc_client.Assets{
			LargeImage: "",
			LargeText:  "",
			SmallImage: "https://weebhub.app/images/circular-logo.png",
			SmallText:  "WeebHub v" + constants.Version,
			SmallURL:   "https://weebhub.app",
		},
...
func isWeebHubButtonPresent(activity *discordrpc_client.Activity) bool {
...
func (p *Presence) SetAnimeActivity(a *AnimeActivity) {
	...
	// Only allow changing small image and text if WeebHub button is present
	if isWeebHubButtonPresent(&activity) {
