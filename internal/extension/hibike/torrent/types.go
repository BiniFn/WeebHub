...
type (
	...
	AnimeSearchOptions struct {
		// The media object provided by WeebHub.
	...
	AnimeTorrent struct {
		...
		// Leave this empty if you want WeebHub to format the size.
		...
		// Else, WeebHub will parse the torrent name to determine if it's a batch.
		IsBatch bool `json:"isBatch,omitempty"`
		// Episode number of the torrent.
		// Return -1 if unknown / unable to determine and WeebHub will parse the torrent name.
		EpisodeNumber int `json:"episodeNumber,omitempty"`
		// Release group of the torrent.
		// Leave this empty if you want WeebHub to parse the release group from the name.
