...
type (
	...
	TorrentItem struct {
		...
		IsQueuedForLocalDownload bool               `json:"isQueuedForLocalDownload,omitempty"` // Whether WeebHub has queued this torrent for local download
		IsDownloadingLocally     bool               `json:"isDownloadingLocally,omitempty"`     // Whether WeebHub is currently downloading this torrent locally
