declare namespace $app {
     ...
     * @file internal/debrid/client/hook_events.go
     * @description
     * DebridAddTorrentRequestedEvent is triggered when WeebHub is about to add a torrent to the debrid provider.
     ...
     * @file internal/debrid/client/hook_events.go
     * @description
     * DebridLocalDownloadRequestedEvent is triggered when WeebHub is about to download a debrid torrent locally.
     ...
     * @description
     * TorrentSearchRequestedEvent is triggered before WeebHub searches anime torrents.
     ...
     * @file internal/torrents/torrent/hook_events.go
     * @description
     * TorrentSearchEvent is triggered after WeebHub assembles the torrent search response.
