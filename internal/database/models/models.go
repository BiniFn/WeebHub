...
type LibrarySettings struct {
	...
	UpdateChannel            string `gorm:"column:update_channel" json:"updateChannel"` // "github", "weebhub", "weebhub_nightly"
	// v3.7.0+
...
type DiscordSettings struct {
	...
	RichPresenceHideWeebHubRepositoryButton bool `gorm:"column:rich_presence_hide_weebhub_repository_button" json:"richPresenceHideWeebHubRepositoryButton"`
