...
func TestComparison(t *testing.T) {
	...
	rule := &anime.AutoDownloaderRule{
		...
		Destination:         "/data/weebhub/library/[Oshi no Ko] 2nd Season",
	...
	//	{
	//		Path: "/data/weebhub/library/[Oshi no Ko] 2nd Season/[SubsPlease] Oshi no Ko - 12 (1080p).mkv",
...
func TestComparison2(t *testing.T) {
	...
	rule := &anime.AutoDownloaderRule{
		...
		EpisodeType:         "recent",
		EpisodeNumbers:      []int{},
		Destination:         "/data/weebhub/library/Dandadan",
...
func TestComparison3(t *testing.T) {
	...
	//lfw := anime.NewLocalFileWrapper([]*anime.LocalFile{
	//	{
	//		Path: "/data/weebhub/library/Dandadan/[SubsPlease] Dandadan - 01 (1080p).mkv",
