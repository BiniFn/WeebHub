...
import (
	...
	debrid_client "weebhub/internal/debrid/client"
	"weebhub/internal/directstream"
	discordrpc_presence "weebhub/internal/discordrpc/presence"
	"weebhub/internal/doh"
	"weebhub/internal/events"
	"weebhub/internal/extension"
	"weebhub/internal/extension_playground"
	"weebhub/internal/extension_repo"
	"weebhub/internal/hook"
	"weebhub/internal/library/autodownloader"
	"weebhub/internal/library/autoscanner"
	"weebhub/internal/library/fillermanager"
	"weebhub/internal/library/playbackmanager"
	"weebhub/internal/library/scanner"
	"weebhub/internal/library_explorer"
	"weebhub/internal/local"
	"weebhub/internal/manga"
	"weebhub/internal/mediaplayers/iina"
	"weebhub/internal/mediaplayers/mediaplayer"
	"weebhub/internal/mediaplayers/mpchc"
	"weebhub/internal/mediaplayers/mpv"
	"weebhub/internal/mediaplayers/vlc"
	"weebhub/internal/mediastream"
	"weebhub/internal/nakama"
	"weebhub/internal/nativeplayer"
	"weebhub/internal/onlinestream"
	"weebhub/internal/platforms/anilist_platform"
	"weebhub/internal/platforms/offline_platform"
	"weebhub/internal/platforms/platform"
	"weebhub/internal/platforms/simulated_platform"
	"weebhub/internal/playlist"
	"weebhub/internal/plugin"
	"weebhub/internal/report"
	"weebhub/internal/torrent_clients/torrent_client"
	"weebhub/internal/torrents/torrent"
	"weebhub/internal/torrentstream"
	"weebhub/internal/updater"
	"weebhub/internal/user"
	"weebhub/internal/util"
	"weebhub/internal/util/filecache"
	"weebhub/internal/util/result"
	"weebhub/internal/videocore"
	"sync"
	"sync/atomic"
...
func NewApp(configOpts *ConfigOptions, selfupdater *updater.SelfUpdater) *App {
	...
	logger.Info().Msgf("app: WeebHub %s-%s", constants.Version, constants.VersionName)
