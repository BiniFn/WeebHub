                    ...
                    <div className="">
                        <Form
                            ...
                            onSubmit={async data => {
                                await saveSettings({
                                    ...
                                    discord: {
                                        ...
                                        richPresenceHideWeebHubRepositoryButton: data?.richPresenceHideWeebHubRepositoryButton ?? false,
                            ...
                            defaultValues={{
                                ...
                                richPresenceHideWeebHubRepositoryButton: status?.settings?.discord?.richPresenceHideWeebHubRepositoryButton ?? false,
                        ...
                        >
                            {(f) => {
                                return <>
                                    <SettingsIsDirty />
                                    <TabsContent value="weebhub" className={tabContentClass}>
                                            ...
                                            <AccordionItem value="qbittorrent">
                                                ...
                                                <AccordionContent className="p-0 py-4 space-y-4">
                                                    ...
                                                    <Field.Text
                                                        ...
                                                        label="Tags"
                                                        help="Comma separated tags to apply to downloaded torrents. e.g. weebhub,anime"
                                                    />
                                                    <Field.Text
