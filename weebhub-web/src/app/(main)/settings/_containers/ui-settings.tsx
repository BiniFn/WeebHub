...
export function UISettings() {
    ...
    function handleSave(data: z.infer<typeof themeSchema>) {
        if (colord(data.backgroundColor).isLight()) {
            toast.error("WeebHub does not support light themes")
            return
        }
            ...
            {(f) => (
                <>
                    ...
                    >
                        ...
                        {/*            help="WeebHub will try to fix border rendering artifacts. This setting only affects this client/browser."*/}
