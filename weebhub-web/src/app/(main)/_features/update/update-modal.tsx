            ...
            >
                ...
                <div className="space-y-2">
                    ...
                    {serverStatus?.isDesktopSidecar && <Alert
                        intent="info"
                        description="Update WeebHub from the desktop application."
                    />}
                    ...
                    <div className="flex gap-2 w-full items-center !mt-4">
                        {!serverStatus?.isDesktopSidecar && <Modal
                            ...
                            title={<span>Update WeebHub</span>}
                        >
                            <div className="space-y-4">
                                <p>
                                    WeebHub will perform an update by downloading and replacing existing files.
    ...
    return (
        ...
        >
            ...
            <DirectorySelector
                ...
                value={destination}
                rightAddon={`/weebhub-${release.version}`}
            />
