...
export default function _page() {
    ...
    // text-lg">Connect your MyAnimeList account to WeebHub</p> <Button onClick={() => { window.open(OAUTH_URL, "_self") }} intent="primary"
    ...
    // MyAnimeList account to WeebHub</p> <p className="text-[--muted]"> Due to authentication restrictions, you can only connect your MyAnimeList
    ...
    return (
        <div className="p-12 pt-0 space-y-0">
            ...
            {/*    <p>*/}
            {/*        Your MyAnimeList account is connected to WeebHub.*/}
            {/*    </p>*/}
            ...
            {/*            Your progress will be automatically updated on MAL whenever you watch an episode or read a chapter with WeebHub.*/}
            {/*        </span></li>*/}
