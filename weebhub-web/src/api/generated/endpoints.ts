...
export const API_ENDPOINTS = {
    ...
    NAKAMA: {
        ...
        /**
         *  @description
         *  Route creates a WeebHub Room and connects to it as host.
         *  This creates a room on the WeebHub Rooms relay server and connects as the host. Peers can then join using the returned URL.
         */
    ...
    STATUS: {
         ...
         *  This returns the content of the most recent weebhub- log file after flushing logs.
         */
        GetLatestLogContent: {
